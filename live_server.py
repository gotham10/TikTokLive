...
async def read_root():
    ...
    <body class="bg-zinc-900 text-white flex items-center justify-center h-screen bg-gradient-radial">
        <div class="max-w-md w-full text-center bg-zinc-900/50 backdrop-blur-sm border border-zinc-700 p-8 rounded-2xl shadow-2xl">
            ...
            <h1 class="text-4xl font-extrabold mb-3 text-transparent bg-clip-text bg-gradient-to-r from-gray-200 to-gray-400">Dynamic TikTok Live Overlay</h1>
        ...
        <script>
            document.getElementById('user-form').addEventListener('submit', function(event) {
                ...
                if (username) {
                    window.location.href = `/${username.replace(/^@/, '')}`;
                }
            });
        </script>
    </body>
